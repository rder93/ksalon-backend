...
class LoungeServiceController extends Controller
{
    ...
    public function buscarLoungesServices(Request $request)
    {
        ...
        $salones = DB::table('lounges_services')
            ->select('lounges_services.id', 'lounge_id', 'lounges.nombre as nombre_salon', 'users.name as nombre_usuario', 'service_id', 'lounges_services.precio', 'lounges.created_at', 'lounges.updated_at', 'services.nombre as nombre_servicio', 'lounges.latitud', 'lounges.altitud')
