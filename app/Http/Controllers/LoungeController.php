...
class LoungeController extends Controller
{
    ...
    public function edit($lounge_id)
    {
        $lounge =   DB::table('lounges')
                    ->select('lounges.id', 'lounges.nombre', 'lounges.descripcion', 'lounges.latitud', 'lounges.longitud', 'lounges.user_id', 'lounges.category_id', 'lounges.created_at', 'lounges.updated_at', 'categories.nombre as nombre_categoria', 'users.name as nombre_usuario', 'users.id as id_usuario')
